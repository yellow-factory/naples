...
typedef bool PredicateOf();
typedef bool PredicateOf1<T>(T t);
typedef bool PredicateOf2<T1, T2>(T1 t1, T2 t2);
typedef bool PredicateOf3<T1, T2, T3>(T1 t1, T2 t2, T3 t3);
